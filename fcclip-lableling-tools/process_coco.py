coco_path = 'datasets/output_new_417_coco.json'
output_json = 'datasets/output_new_417_coco_merge.json'
import json 
import os
import numpy as np
import cv2
        ...
        for person_ann in new_anns_person:
            if isinstance(person_ann['segmentation'], list):
                ...
                try:
                    ...
                    person_mask = mask.decode(person_ann['segmentation'])
            for acc_ann in new_anns_acc:
                if isinstance(acc_ann['segmentation'], list):
                    ...
                    try:
                        ...
                        acc_mask = mask.decode(acc_ann['segmentation'])
