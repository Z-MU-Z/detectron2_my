...
output_json = 'datasets/instances_val2017_p3m_10k_NP.json'
image_path = 'datasets/P3M-10k/validation/P3M-500-NP'
rgb_path = image_path  + '/original_image'
...
for img in tqdm(img_list):
    ...
    new_annotations.append({'image_id': img_id, 'category_id': 1, 'segmentation': mask, 'id': ann_id, 'bbox': mask_util.toBbox(mask).tolist(), 'area': mask_util.area(mask).item(), 'iscrowd': 0})
