...
coconut_path = 'datasets/coco_instances_train2017_coconut_s.json'
output_json = 'datasets/instances_train2017_coconuts_sport_merge_car.json'
import json 
import os
import numpy as np
import cv2
...
# 处理后生成新的json文件
new_coco = {'images': [], 'annotations': [], 'categories': oricoco['categories']}
new_images = []
new_annotations = []
